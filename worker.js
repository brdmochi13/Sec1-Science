const HTML = `
     ,
    {
      num:34, title:'WA3 Booster — Cells Deep Dive (Ch.6)',
      secA:[
        {q:'Which part of the cell contains DNA, the hereditary material passed from parents to offspring?',opts:['Cell membrane','Vacuole','Cytoplasm','Nucleus'],ans:3,skill:'Cells',fb:'The nucleus contains DNA — the genetic/hereditary material. DNA carries the instructions for making new cells and passing traits from parents to offspring.'},
        {q:'A plant cell is placed in salty water. The large central vacuole shrinks. What does this tell you about the vacuole?',opts:['It produces energy for the cell','It stores water and can lose or gain water depending on conditions','It controls what enters the cell','It carries out photosynthesis'],ans:1,skill:'Cells',fb:'The vacuole stores water (and food and waste materials). When a plant is in salty water, water leaves the vacuole by osmosis, causing it to shrink and the plant to wilt.'},
        {q:'Robert Hooke first used the word "cell" after observing cork under a microscope. The cork appeared to him as a set of small rooms. What Latin word does "cell" come from?',opts:['Cella (small room)','Cellula (little unit)','Cellum (enclosure)','Cello (hollow)'],ans:0,skill:'Cells',fb:'The word "cell" comes from the Latin word cella, meaning "small room". Robert Hooke saw cork tissue that looked like a honeycomb of tiny rooms.'},
        {q:'A scientist discovers a new single-celled organism. It has a cell membrane, cytoplasm, and nucleus but NO cell wall and NO chloroplasts. What can she conclude?',opts:['It is a plant cell','It is an animal cell','It could be either — not enough information','It is a fungus'],ans:1,skill:'Cells',fb:'No cell wall and no chloroplasts are both animal cell characteristics. A plant cell would have a cell wall and potentially chloroplasts. This organism fits the typical animal cell model.'},
        {q:'What does the cell membrane do that the cell wall cannot?',opts:['Provide rigid structural support','Control which substances enter and leave the cell','Give the cell a fixed regular shape','Protect the cell from bursting'],ans:1,skill:'Cells',fb:'The cell membrane is PARTIALLY PERMEABLE — it selectively controls what substances enter and leave. The cell wall is FULLY PERMEABLE — it allows everything through and only provides structural support and shape.'},
        {q:'AI systems are now used in medicine to analyse cell images. What is ONE advantage of using AI to identify cancer cells?',opts:['AI can create new cells','AI can identify cancer cells with greater speed and accuracy than manual inspection','AI can cure cancer','AI can replace the need for microscopes'],ans:1,skill:'Cells',fb:'AI systems introduced to thousands of images of various cell types can correctly identify cancer cells with greater speed and accuracy, helping doctors diagnose the type of cancer a patient has — as stated in the textbook.'},
        {q:'In a plant, root hair cells absorb water and mineral salts from the soil. Root hair cells have NO chloroplasts. Why not?',opts:['Root hair cells do not need energy','Roots are underground — no light reaches them so chloroplasts would be useless','Root hair cells are animal cells','Chloroplasts are too large to fit in root hair cells'],ans:1,skill:'Cells',fb:'Chloroplasts need light to carry out photosynthesis. Since roots are underground and receive no light, having chloroplasts would serve no purpose. This is an example of cellular specialisation.'},
        {q:'Which sequence correctly shows how cells are organised in a multicellular organism?',opts:['Organ → Cell → Tissue → System → Organism','Cell → Organ → Tissue → System → Organism','Cell → Tissue → Organ → System → Organism','System → Organ → Tissue → Cell → Organism'],ans:2,skill:'Cells',fb:'The correct hierarchy from smallest to largest: Cell → Tissue → Organ → System → Organism. Cells of the same type form tissues; different tissues form organs; organs form systems; systems form the organism.'}
      ],
      secB:[
        {stmt:'Chloroplasts carry out photosynthesis — therefore ALL plant cells must have chloroplasts.',ans:false,reason:'Not all plant cells have chloroplasts. Root hair cells, for example, are plant cells that do not contain chloroplasts because they are underground and receive no light. Cells can be specialised exceptions to the typical cell model.'},
        {stmt:'The cytoplasm is described as a jelly-like substance because it is the site where most chemical reactions in the cell take place.',ans:true,reason:'The cytoplasm is the jelly-like fluid that fills the cell, and it IS the site where most of the cell's chemical reactions occur. Both statements are correct — it is jelly-like AND it is where chemical reactions happen.'},
        {stmt:'An electron microscope and a light microscope can both be used to see all cell structures with equal clarity.',ans:false,reason:'An electron microscope provides MUCH higher magnification and resolution than a light microscope. Some structures that cannot be seen clearly under a light microscope can be observed in great detail under an electron microscope.'},
        {stmt:'The Euglena organism challenges the original two-kingdom classification of living things as either plants or animals.',ans:true,reason:'Euglena has characteristics of BOTH plant cells (chloroplasts for photosynthesis) AND animal cells (can actively swim and absorb food). This led to a new classification system to accommodate organisms with characteristics of both kingdoms.'},
        {stmt:'Division of labour in a multicellular organism means that every cell performs every function needed by the organism.',ans:false,reason:'Division of labour means the OPPOSITE — different specialised cells each perform SPECIFIC functions. For example, muscle cells contract, nerve cells conduct signals, and absorbing cells absorb nutrients. No single cell does everything.'}
      ],
      secC:[
        {type:'str',q:'Figure A shows a typical animal cell and Figure B shows a typical plant cell.
(a) Name ONE structure found in Figure B but NOT in Figure A. [1]
(b) Name TWO structures found in BOTH Figure A and Figure B. [2]
(c) Explain why plant cells need chloroplasts but animal cells do not. [2]',marks:5,scheme:'(a) Any ONE of: cell wall / chloroplast / large central vacuole [1]
(b) Any TWO of: nucleus / cytoplasm / cell membrane / (small) vacuole [2]
(c) Plant cells carry out photosynthesis [1] — they use chloroplasts (which contain chlorophyll) to convert light energy, carbon dioxide, and water into food (glucose). Animal cells cannot photosynthesise [1] — they obtain energy by consuming and digesting food instead.'},
        {type:'str',q:'A student says: "All cells are the same because they all have a nucleus, cytoplasm, and cell membrane."
(a) Give ONE piece of evidence that challenges this statement. [2]
(b) Explain what the word "specialisation" means in the context of cells. [2]',marks:4,scheme:'(a) Any valid example with explanation: Red blood cells do not have a nucleus [1]; OR root hair cells (plant cells) do not have chloroplasts [1]; OR Euglena has features of both plant and animal cells [1]. Award 1 mark for naming the exception, 1 mark for stating what is different about it.
(b) Specialisation means that cells are modified/adapted [1] to perform a specific function more efficiently, even if this means they differ from the typical cell model [1].'},
        {type:'str',q:'Using the organisation of cells in the human digestive system as an example, explain the terms: tissue, organ, and system. [3]',marks:3,scheme:'Tissue: cells of the same type performing the same function grouped together — e.g. muscle tissue in the stomach [1]
Organ: different tissues working together to perform a specific function — e.g. the stomach is an organ made of muscle tissue and lining tissue [1]
System: a group of organs working together to perform various functions — e.g. the digestive system includes the stomach, small intestine, and large intestine [1]'}
      ]
    },
    {
      num:35, title:'WA3 Booster — Particulate Matter Deep Dive (Ch.7)',
      secA:[
        {q:'In 1827, Robert Brown observed pollen grains moving randomly in water. What caused this movement?',opts:['Pollen grains are alive and move on their own','Currents in the water pushed the pollen','Invisible water particles bombarded the pollen grains from all sides','The pollen grains were attracted to each other'],ans:2,skill:'Particulate',fb:'Einstein later explained Brownian motion: the pollen grains were bombarded by invisible water molecules from all sides in random directions. Since the bombardment is uneven, the pollen moves randomly. This proved matter is made of tiny moving particles.'},
        {q:'A perfume bottle is opened at the front of a classroom. Students at the back smell it after 2 minutes. Which factor would make the smell reach them FASTER?',opts:['Lower room temperature','Heavier perfume particles','Higher room temperature','Smaller room'],ans:2,skill:'Particulate',fb:'Higher temperature → particles have more energy → they move faster → diffusion occurs more quickly. Temperature is a key factor affecting the rate of diffusion.'},
        {q:'Dry ice (solid CO₂) is packed around an ice-cream cake. After a while, the dry ice disappears without any liquid forming. What is this process called?',opts:['Melting','Condensation','Evaporation','Sublimation'],ans:3,skill:'Particulate',fb:'Sublimation is when a solid changes DIRECTLY into a gas without passing through the liquid state. Dry ice (solid carbon dioxide) sublimates at room temperature — it goes straight from solid to gas.'},
        {q:'Using the particulate model, which statement correctly explains why liquids cannot be compressed?',opts:['Liquid particles have no energy','Liquid particles are closely packed with little space between them to be pushed closer','Liquid particles are in fixed positions','Liquid particles are too heavy to compress'],ans:1,skill:'Particulate',fb:'Liquids cannot be compressed because the particles are already closely packed with very little space between them — there is nowhere for them to go when force is applied. Compare to gases, which have large spaces between particles and CAN be compressed.'},
        {q:'A student heats water from 20°C to 100°C, then continues heating until all the water boils away. Which state change sequence is correct?',opts:['Solid → Liquid → Gas','Liquid → Gas only','Solid → Gas','Liquid → Gas (no solid involved)'],ans:3,skill:'Particulate',fb:'Starting from liquid water at 20°C, heating causes liquid → gas (boiling). There is no solid involved (the water is already liquid, not ice). So the only state change is liquid to gas (boiling/evaporation).'},
        {q:'Which observation is evidence of Brownian motion that you could see in everyday life?',opts:['Water flowing downhill','Dust particles dancing in a beam of light from a projector','Ice melting in a warm room','Steam rising from a hot drink'],ans:1,skill:'Particulate',fb:'Dust particles dancing in a beam of light appear to move randomly because they are being bombarded by invisible air particles — this IS Brownian motion. The other options are different phenomena (gravity, melting, evaporation).'},
        {q:'The particulate model has limitations. Which is a known limitation?',opts:['It cannot explain why matter has mass','The particles in the model are shown as spheres but real particles may not be spherical','It cannot explain the three states of matter','The model has been disproved by modern science'],ans:1,skill:'Particulate',fb:'As stated in the textbook, the particulate model shows particles as spheres but real particles may not be spherical. The model also does not show the constant random movement of particles. These are known limitations — but the model is still very useful for explaining properties of matter.'},
        {q:'A patient has a stroke. A doctor uses DW-MRI to detect the affected area of the brain. What property of water does DW-MRI measure?',opts:['The temperature of water in brain tissue','The colour of water molecules','The diffusion patterns of water in body tissues','The number of water particles in the brain'],ans:2,skill:'Particulate',fb:'Diffusion-weighted MRI (DW-MRI) detects changes in the DIFFUSION PATTERNS of water in body tissues. When a stroke occurs, the affected brain tissue changes how water diffuses through it — this change shows up as a white area on the DW-MRI image.'}
      ],
      secB:[
        {stmt:'When a substance condenses from gas to liquid, particles gain energy and move faster.',ans:false,reason:'During condensation (gas → liquid), the OPPOSITE happens: particles LOSE energy and slow down. The forces of attraction pull the particles closer together. Gaining energy and moving faster describes what happens during boiling or evaporation (liquid → gas).'},
        {stmt:'Diffusion is the net movement of particles from a region of lower concentration to a region of higher concentration.',ans:false,reason:'This is the OPPOSITE of the correct definition. Diffusion is the NET movement of particles from a region of HIGHER concentration to a region of LOWER concentration. The net movement continues until concentrations are equal throughout.'},
        {stmt:'When ink is added to water, the ink particles eventually spread evenly throughout the water due to diffusion.',ans:true,reason:'Ink particles are in constant random motion. They move from the region of high concentration (where the ink was dropped) to regions of lower concentration (the rest of the water) by diffusion, until the concentration is uniform throughout — the water is evenly coloured.'},
        {stmt:'Conservation of mass means that the total mass of a substance stays the same during expansion because no particles are created or destroyed.',ans:true,reason:'Correct. During expansion (or any state change), the NUMBER and SIZE of particles remain unchanged. Only the DISTANCES between particles change. Since mass depends on the number and size of particles, mass is conserved.'},
        {stmt:'A gas has a definite volume because its particles are held together by very strong forces of attraction.',ans:false,reason:'A gas does NOT have a definite volume. Gas particles are held together by WEAK forces of attraction, are very far apart, and move rapidly — they fill and take the shape of any container. Strong forces of attraction describe SOLIDS, not gases.'}
      ],
      secC:[
        {type:'str',q:'(a) State the difference between boiling and condensation in terms of particle behaviour. [4]
(b) Using the particulate nature of matter, explain what happens when a gas is cooled and becomes liquid (condensation). [3]',marks:7,scheme:'(a) Boiling: particles in liquid gain energy [1], move faster and further apart [1], overcome forces of attraction [1], escape as gas [1]
Condensation: particles in gas lose energy [1], slow down [1], pulled closer by forces of attraction [1], become liquid [1] — award 4 marks total for 4 correct points
(b) When a gas is cooled, particles lose energy [1]. They move more slowly [1]. Forces of attraction pull the particles closer together [1] until they become a liquid — condensation occurs.'},
        {type:'str',q:'A student sets up an experiment: a few drops of food colouring are added to a beaker of cold water and another beaker of hot water.
(a) In which beaker will diffusion occur faster? Give a reason. [2]
(b) After 30 minutes, what would you observe in both beakers? [1]
(c) State the definition of diffusion. [1]',marks:4,scheme:'(a) Hot water [1]; because particles in hot water have more energy and move faster, so diffusion occurs at a faster rate [1]
(b) In both beakers, the colour would be evenly/uniformly distributed throughout the water [1]
(c) Diffusion is the net movement of particles from a region of higher concentration to a region of lower concentration [1]'},
        {type:'str',q:'Explain how the particulate nature of matter is used to explain why: (a) a gas fills a container completely [2], (b) a solid keeps its shape [2], (c) a liquid flows but cannot be compressed [2].',marks:6,scheme:'(a) Gas particles are very far apart and move rapidly and randomly in all directions [1], so they spread out to fill the entire volume of any container [1]
(b) Solid particles are very closely packed in an orderly arrangement and vibrate about fixed positions [1], so the solid maintains a definite, fixed shape [1]
(c) Liquid particles are closely packed (cannot be compressed — no space to push closer) [1] but move randomly and slide past one another (can flow and take the shape of the container) [1]'}
      ]
    },
    {
      num:36, title:'WA3 Final Challenge — Exam Simulation (Ch.6+7)',
      secA:[
        {q:'Table 7.1 shows properties of three states. Which row correctly shows ALL properties of a liquid?',opts:['Definite volume: Yes, Definite shape: Yes, Can be compressed: No','Definite volume: Yes, Definite shape: No, Can be compressed: No','Definite volume: No, Definite shape: No, Can be compressed: Yes','Definite volume: No, Definite shape: Yes, Can be compressed: No'],ans:1,skill:'Particulate',fb:'A liquid: has DEFINITE volume (yes), has NO definite shape (takes the shape of its container), CANNOT be compressed (particles already closely packed). Option B matches all three.'},
        {q:'A student adds red dye to water. After 5 minutes the dye has not fully spread. Which action would NOT speed up diffusion?',opts:['Warming the water','Stirring the water','Using smaller/lighter dye particles','Cooling the water'],ans:3,skill:'Particulate',fb:'Cooling the water would SLOW diffusion — colder particles have less energy and move more slowly. Warming, stirring, and using smaller/lighter particles all increase the rate of diffusion.'},
        {q:'In Figure 6.7 (textbook), the typical animal cell is shown as round/irregular and the typical plant cell is shown as rectangular with a regular shape. Why does the plant cell have a more regular shape?',opts:['Plant cells are larger','The cell wall is rigid and gives the plant cell a fixed, regular shape','Plant cells have more cytoplasm','The nucleus in plant cells is larger'],ans:1,skill:'Cells',fb:'The cell wall is rigid (tough, cellulose structure) and gives the plant cell its fixed, regular rectangular shape. Animal cells, which lack a cell wall, have irregular, flexible shapes.'},
        {q:'A G2 student is asked to identify a state change. She observes: "Particles lose energy, slow down, and are pulled by forces of attraction from a region of close but disorderly particles into fixed positions." Which state change is this?',opts:['Melting','Boiling','Freezing','Sublimation'],ans:2,skill:'Particulate',fb:'This describes FREEZING (liquid → solid): particles lose energy, slow down, and are pulled by forces of attraction into fixed, orderly positions. "Close but disorderly" = liquid; "fixed positions" = solid.'},
        {q:'Both plants and animals are multicellular organisms. What is ONE advantage of being multicellular rather than unicellular?',opts:['Multicellular organisms are always larger','Cells can be specialised for different functions, allowing division of labour and more efficient functioning','Multicellular organisms have more organelles per cell','Multicellular organisms do not need food'],ans:1,skill:'Cells',fb:'The key advantage of multicellular organisation is division of labour — cells can be specialised for specific functions (e.g. nerve cells, muscle cells, absorbing cells), allowing the organism as a whole to function much more efficiently than if every cell had to do everything.'},
        {q:'Virus particles are too small to see but remain suspended in air after an infected person coughs. Which concept from Chapter 7 explains how virus particles spread to other people in the room?',opts:['Expansion and contraction','Conservation of mass','Diffusion and Brownian motion','State changes'],ans:2,skill:'Particulate',fb:'Virus particles (suspended in air like smoke particles) exhibit Brownian motion — they move randomly due to collisions with air particles. Through diffusion, they spread from high concentration (near the infected person) to lower concentration (rest of the room), potentially infecting others.'},
        {q:'Which of the following correctly shows the THREE structures unique to plant cells (not found in typical animal cells)?',opts:['Nucleus, cytoplasm, cell membrane','Cell wall, chloroplast, large central vacuole','Nucleus, chloroplast, vacuole','Cell wall, nucleus, cytoplasm'],ans:1,skill:'Cells',fb:'The THREE structures unique to plant cells are: cell wall (provides rigid structural support), chloroplast (site of photosynthesis), and large central vacuole (stores water/food/waste). Nucleus, cytoplasm, and cell membrane are found in BOTH plant and animal cells.'},
        {q:'Scientists use computer modelling and AI to track the movements of particles in matter. What does this tell us about the particulate model?',opts:['The model is completely accurate and does not need improvement','Scientists have abandoned the particulate model','The model is still being improved as technology advances — it is an ongoing scientific endeavour','AI has replaced all need for particle models'],ans:2,skill:'Particulate',fb:'As stated in the textbook: "With advancements in technology, scientists are exploring the use of computer modelling to help them visualise the vibrations of the constituents of matter more accurately." Science is an ongoing endeavour — models are continuously improved.'}
      ],
      secB:[
        {stmt:'A solid cannot flow because its particles vibrate about fixed positions and cannot slide past each other.',ans:true,reason:'Correct. Solid particles are very closely packed in an orderly arrangement and vibrate about fixed positions — they cannot slide past each other, which is why solids cannot flow. Liquids can flow because their particles CAN slide past one another.'},
        {stmt:'A cell wall is found in plant cells and performs the same function as the cell membrane — controlling what enters and leaves the cell.',ans:false,reason:'The cell WALL and cell MEMBRANE have DIFFERENT functions. The cell wall is FULLY PERMEABLE and provides rigid structural support / gives the cell its regular shape. Only the cell MEMBRANE is partially permeable and controls the movement of substances into and out of the cell.'},
        {stmt:'When ice melts, the water produced has less mass than the original ice because some particles are used up during melting.',ans:false,reason:'Mass is CONSERVED during melting (and all state changes). The SAME number of particles are present — no particles are created or destroyed. The water produced has EXACTLY the same mass as the ice that melted.'},
        {stmt:'Bioengineers can use knowledge of cells to 3D print artificial organs such as hearts and livers for patients who need transplants.',ans:true,reason:'As stated in the textbook: bioengineers apply knowledge of living cells and scientific principles to create artificial body parts and organs through 3D printing. Patients who need replacement organs can receive them without waiting for a suitable donor.'},
        {stmt:'The particulate model perfectly represents the constituents of matter and has no limitations.',ans:false,reason:'As stated in the textbook, the particulate model has limitations — it cannot fully represent all aspects of matter. For example, real particles may not be spherical (as shown in the model), and the model does not show the constant random movement of particles. Scientists use computer simulations to develop more accurate models.'}
      ],
      secC:[
        {type:'str',q:'(a) A nurse wears a mask when treating an infectious patient. Using the concept of diffusion and Brownian motion, explain why the mask helps reduce the risk of infection. [4]
(b) State ONE way in which knowledge of diffusion has been applied in medical imaging technology. [2]',marks:6,scheme:'(a) When the patient breathes or coughs, virus particles are released into the air [1]. These particles undergo Brownian motion — they move randomly due to bombardment by air particles [1]. Through diffusion, virus particles spread from the region of high concentration (near the patient) to regions of lower concentration [1]. A mask prevents most virus particles from being dispersed into the air or from reaching the nurse's mouth and nose [1].
(b) Diffusion-weighted MRI (DW-MRI) uses the diffusion patterns of water in body tissues to detect changes caused by diseases such as stroke or cancer [1]. It allows doctors to identify the stage of disease and monitor responses to treatment [1].'},
        {type:'str',q:'A student is given an unknown cell to examine. She observes: a definite rectangular shape, a large space in the centre filled with fluid, and structures that appear green under the microscope.
(a) Identify the type of cell. Give TWO reasons based on her observations. [3]
(b) Name the green structures she observes and state their function. [2]
(c) Name the structure that gives this cell its rectangular shape. [1]',marks:6,scheme:'(a) Plant cell [1]; because it has a regular rectangular shape (due to cell wall) [1]; AND/OR has a large central vacuole [1]; AND/OR has green structures (chloroplasts) which are found only in plant cells [1] — award max 2 marks for reasons
(b) Chloroplasts [1]; function: carry out photosynthesis — they contain chlorophyll and allow the plant to convert light energy into food/glucose [1]
(c) Cell wall [1]'},
        {type:'str',q:'Compare and contrast the particulate arrangement in a solid and a liquid. Your answer should address: (i) arrangement of particles, (ii) movement of particles, (iii) forces of attraction, and (iv) whether each state has a definite volume and shape. [8]',marks:8,scheme:'Arrangement: Solid — very closely packed in orderly/regular arrangement [1]; Liquid — closely packed but in disorderly/random arrangement [1]
Movement: Solid — particles vibrate about fixed positions [1]; Liquid — particles move randomly and slide past one another [1]
Forces: Solid — held together by very strong forces of attraction [1]; Liquid — held together by strong forces of attraction (weaker than solid) [1]
Volume/Shape: Solid — definite volume AND definite shape [1]; Liquid — definite volume but NO definite shape (takes shape of container) [1]'}
      ]
    }
...
var PAPERSign:center;margin-top:.75rem">
        <button onclick="guestLogin()" style="background:none;border:none;color:#6b7280;font-size:.78rem;cursor:pointer;text-decoration:underline">Continue as Guest (no progress saved)</button>
      </div><!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
/* ══ AUTH OVERLAY ══ */
.auth-overlay{position:fixed;top:0;left:0;right:0;bottom:0;background:#1c1c1e;z-index:999999;display:flex;align-items:flex-start;justify-content:center;padding:1.5rem 1rem;overflow-y:auto;font-family:'Source Sans 3',sans-serif}
.auth-box{background:#ffffff;border-radius:16px;padding:1.5rem;max-width:420px;width:100%;box-shadow:0 24px 70px rgba(0,0,0,.6);margin:auto}
...
<div class="auth-overlay" id="authOverlay">
  <div class="auth-box" style="max-width:360px">
    <div class="auth-logo" style="font-size:1.3rem;margin-bottom:.3rem">S1 Science <span>Mastery</span> · G3</div>
    <div class="auth-sub" style="margin-bottom:.8rem;font-size:.82rem">Enter your name and PIN to continue</div>

    <div style="display:flex;gap:.5rem;margin-bottom:.6rem">
      <div style="flex:1">
        <label style="font-size:.72rem;font-weight:600;color:var(--muted);display:block;margin-bottom:.25rem">NAME</label>
        <input id="authName" type="text" placeholder="e.g. Mokshith"
          style="width:100%;padding:.5rem .7rem;border:1.5px solid #d1d5db;border-radius:8px;font-size:.9rem;box-sizing:border-box;font-family:inherit"
          onkeydown="if(event.key==='Enter')document.getElementById('authPwd').focus()">
      </div>
      <div style="flex:1">
        <label style="font-size:.72rem;font-weight:600;color:var(--muted);display:block;margin-bottom:.25rem">PIN</label>
        <input id="authPwd" type="password" placeholder="PIN"
          style="width:100%;padding:.5rem .7rem;border:1.5px solid #d1d5db;border-radius:8px;font-size:.9rem;box-sizing:border-box;font-family:inherit"
          onkeydown="if(event.key==='Enter')doSimpleLogin()">
      </div>
    </div>

    <div id="authErr" style="color:#dc2626;font-size:.75rem;min-height:1rem;margin-bottom:.4rem;text-align:center"></div>

    <button id="authSubmitBtn"
      onclick="
        var n=document.getElementById('authName').value.trim()||'Student';
        var p=document.getElementById('authPwd').value.trim();
        if(!p){document.getElementById('authErr').textContent='Please enter your PIN.';return;}
        var r='student';
        if(p==='parent'){r='parent';if(n==='Student')n='Parent';}
        if(p==='teacher'){r='teacher';if(n==='Student')n='Teacher';}
        window._authName=n; window._authRole=r;
        document.getElementById('authOverlay').style.display='none';
        if(typeof onAuthSuccess==='function'){
          window.currentUser={uid:'local_'+n.toLowerCase(),displayName:n,email:n+'@local'};
      ...
      "
      style="width:100%;padding:.65rem;background:#16a34a;color:#fff;border:none;border-radius:8px;font-size:.95rem;font-weight:700;cursor:pointer;font-family:inherit;margin-bottom:.2rem">
      Sign In →
    </button>
    <div style="text-align:center;margin-top:.3rem">
      <span onclick="document.getElementById('authOverlay').style.display='none';if(typeof onAuthSuccess==='function'){window.currentUser={uid:'guest',displayName:'Guest',email:'guest@local'};window.currentRole='student';onAuthSuccess();}"
        style="font-size:.75rem;color:#6b7280;cursor:pointer;text-decoration:underline">
        Continue as Guest (no progress saved)
      </span>
    </div>

    <div style="margin-top:.7rem;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:.5rem .7rem;font-size:.73rem;color:#166534;line-height:1.6">
      <strong>Accounts:</strong> &nbsp;
      👦 Mokshith / <code>1234</code> &nbsp;·&nbsp;
      👨‍👩‍👦 Parent / <code>parent</code> &nbsp;·&nbsp;
      👩‍🏫 Teacher / <code>teacher</code><br>
      <span style="color:#9ca3af">Any other name + any PIN = guest student</span>
    </div>
  </div>
</div>
...
<div class="topbar">
  <div class="logo">S1 Science <span>Mastery</span> · G3 <span id="roleBadge" class="role-badge role-student" style="display:none">Student</span></div>
  <div class="top-btns" id="topBtns">
    <span id="userDisplayName" style="color:rgba(255,255,255,.7);font-size:.78rem;display:none"></span>
    <button class="tbtn tbtn-outline" id="btnAnswerKey" onclick="openAnswerKeyModal()" style="display:none">🔐 Keys</button>
    <button class="tbtn tbtn-outline" id="btnBrief" onclick="openTeacherBriefModal()" style="display:none">📋 Brief</button>
...
<div id="dashTab" class="tab-content active">
  ...
  <div class="card">
    ...
    <div class="card-body" style="display:flex;flex-direction:column;align-items:center;gap:.75rem">
      <div id="radarChart" style="min-height:200px;display:flex;align-items:center;justify-content:center"></div>
...
if (USE_FIREBASE) {
  try {
    ...
    console.warn('Firebase init failed:', e.message, '— running in local mode');
    USE_FIREBASE = false;
    db = null; auth = null;
  }
}
...
function guestLogin() {
  doSimpleLoginAs('Guest', 'student');
}

function doSimpleLogin() {
  var name = (document.getElementById('authName').value.trim()) || 'Student';
  var pin  = document.getElementById('authPwd').value.trim();
  var errEl = document.getElementById('authErr');
  errEl.textContent = '';

  if (!pin) { errEl.textContent = 'Please enter your PIN.'; return; }

  // PIN-based role detection
  var role = 'student';
  if (pin === 'parent')  { role = 'parent';  if (name === 'Student') name = 'Parent'; }
  if (pin === 'teacher') { role = 'teacher'; if (name === 'Student') name = 'Teacher'; }
  if (name === 'Mokshith' && pin === '1234') role = 'student';

  doSimpleLoginAs(name, role);
}

function doSimpleLoginAs(name, role) {
  var uid = 'local_' + name.toLowerCase().replace(/\\s+/g,'_');
  currentUser  = { uid: uid, displayName: name, email: uid + '@local' };
  currentRole  = role;
  onAuthSuccess();
  // Try Firebase sign-in silently in background — if succeeds, reload data with real UID
  if (USE_FIREBASE && auth) {
    var emailMap = {
      'mokshith': 'mokshith@sci.sg',
      'parent':   'parent@sci.sg',
      'teacher':  'teacher@sci.sg'
    };
    var fbEmail = emailMap[name.toLowerCase()];
    var pwdMap  = { 'mokshith@sci.sg': 'Abcd1234', 'parent@sci.sg': 'Abcd1234', 'teacher@sci.sg': 'Abcd1234' };
    if (fbEmail && pwdMap[fbEmail]) {
      auth.signInWithEmailAndPassword(fbEmail, pwdMap[fbEmail])
        .then(function(uc) {
          // Update to real Firebase user — getUID() will now return real UID
          currentUser = uc.user;
          // Reload data from Firebase with correct UID
          loadDataFromFirebase();
        })
        .catch(function(e) { console.warn('Background Firebase login failed:', e.message); });
    }
  }
}

function doAuth() { doSimpleLogin(); }
    ...
    if (user) {
      ...
      db.collection('users').doc(user.uid).get()
        .then(function(doc) {
          ...
          if (document.getElementById('authOverlay').style.display !== 'none') onAuthSuccess();
        })
        .catch(function(e) {
...
var PAPER_CHAP = {
  ...
  30:['ch12'],31:['ch12'],
  32:['ch13'],33:['ch13'],
  34:['ch6'],       // Cells Deep Dive
  35:['ch7'],       // Particulate Deep Dive
  36:['ch6','ch7']  // Final Challenge
};
...
function getUID() {
  ...
  // Map local simple-login names to real Firebase UIDs for data continuity
  var UID_MAP = {
    'local_mokshith': 'wyq8YMBKDaVWD0hhfkpoQ396gN63',
    'local_parent':   'TwmeCWdktHQToxQxboyPdSp0unE3',
    'local_teacher':  'J90pH8Acq0PBaJsfHXOAvxgx38h1'
  };
  return UID_MAP[currentUser.uid] || currentUser.uid || currentUser.email || 'anon';
}
...
function loadDataFromFirebase() {
  ...
  db.collection('progress').doc(uid).get().then(function(doc) {
    if (doc.exists) {
      var d = doc.data();
      // Merge with any local data (take the one with more history)
      var local = loadData();
      var fbHist = d.history || [];
      var locHist = local.history || [];
      if (fbHist.length >= locHist.length) {
        localStorage.setItem(STORAGE_KEY + '_' + uid, JSON.stringify(d));
      }
      renderDashboard();
    } else {
      // No Firebase doc yet — push local data up to Firebase
      var local = loadData();
      if (local.history && local.history.length > 0) {
        db.collection('progress').doc(uid).set(local)
          .catch(function(e){ console.warn('Firebase push error:', e); });
      }
      renderDashboard();
    }
  }).catch(function(e) { console.warn('Firebase load error:', e.message); renderDashboard(); });
}
...
function renderRadar(d){
  ...
  if(!el) return;
  // Always render radar — shows 0% baseline when no history yet
